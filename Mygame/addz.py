...
sky_surface = pygame.image.load('background/Sky.jpg').convert()
ground_surface = pygame.image.load('background/ground.png').convert()

# score_surf = test_font.render('Addz Game', False, (64,64,64))
# score_rect = score_surf.get_rect(center = (400,50))

#obstacles
snail_surf = pygame.image.load('snail/snail1.png').convert_alpha()
fly_surf = pygame.image.load('Fly/Fly1.png').convert_alpha()
...
player_rect = player_surf.get_rect(topleft = (80,195))
player_gravity = 0
    ...
    for event in pygame.event.get():
        ...
        if game_active:
            if event.type == obstacle_timer:
                ...
                # else:
                #     obstacle_rect_list.append(fly_surf.get_rect(bottomright = (randint(900,1100),180.5)))
